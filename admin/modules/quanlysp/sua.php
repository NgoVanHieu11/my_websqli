...
<p>Sửa sản phẩm</p>
    ...
    ?>    
        <form action="../admin/modules/quanlysp/xuly.php?idsanpham=<?php echo $row['id_sanpham'] ?>" method="POST" enctype="multipart/form-data">
            <tr>
                <td>Tên sản phẩm</td>
            ...
            <tr>
                <td>Mã sp</td>
                <td><input type="text" <?php echo $row['masp'] ?> name="masp"></td>
            </tr>
            <tr>
                <td>Giá sp</td>
                <td><input type="text" <?php echo $row['giasp'] ?> name="giasp"></td>
            </tr>
            <tr>
                <td>Số lượng</td>
                <td><input type="text" <?php echo $row['soluong'] ?> name="soluong"></td>
            </tr>
            <tr>
                <td>Hình ảnh</td>
                <td>
