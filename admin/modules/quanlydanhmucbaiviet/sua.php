...
<p>Sửa danh mục sản phẩm</p>
    <table border="1" with="50%" style="border-collapse: collapse;">
        <form action="../admin/modules/quanlydanhmucbaiviet/xuly.php?idbaiviet=<?php echo $_GET['idbaiviet'] ?>" method="POST">
            <?php
            ...
            <tr>
                <td collapse="2"><input type="submit" name="suadanhmucbaiviet" value="Sửa danh mục bài viết"></td>
            </tr>
            <?php
            }
            ?>
