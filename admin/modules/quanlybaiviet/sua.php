...
<p>Sửa bài viết</p>
    ...
    ?>    
        <form action="../admin/modules/quanlybaiviet/xuly.php?idbaiviet=<?php echo $row['id'] ?>" method="POST" enctype="multipart/form-data">
            <tr>
                <td>Tên bài viết</td>
            ...
            <tr>
                <td collapse="2"><input type="submit" name="suabaiviet" value="Sửa bài viết"></td>
            </tr>
        </from>
        <?php
        }
